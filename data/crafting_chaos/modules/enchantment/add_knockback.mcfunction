# Add knockback enchantment with random level
...
# Apply knockback based on random level
execute if score $result crafting_chaos.temp matches 1 run enchant @s minecraft:knockback 1
execute if score $result crafting_chaos.temp matches 2.. run enchant @s minecraft:knockback 2
